...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log(swiperContainer); // Check if this logs the correct element
    if (swiperContainer) {
        let swiperPortfolio = new Swiper(swiperContainer, {
            slidesPerView: 'auto',
            centeredSlides: true,
            speed: 600,
            loop: true,
...
// Function to show the certificate image
function showCertificate(imageUrl) {
    var certificateViewer = document.getElementById('certificateViewer');
...
// Function to hide the certificate viewer
...
//Function to flip card in education section
function flipCard(element) {
    const educationContent = element.closest('.education__content');
    educationContent.classList.toggle('flip');
  }
